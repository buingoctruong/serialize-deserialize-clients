...
import github.io.truongbn.jsonclients.model.Clients.Client;
import github.io.truongbn.jsonclients.model.Clients.EyeColor;
import github.io.truongbn.jsonclients.model.Clients.Partner;
...
public class ClientsGenerator implements DataGenerator<Clients> {
    ...
    private static int appendClient(Clients uc, int sizeAvailable) {
        ...
        u.setRegistered(LocalDate.of(1900 + RandomUtils.nextInt(110), 1 + RandomUtils.nextInt(12),
        ...
        for (int i = 0; i < nPartners; i++) {
            ...
            OffsetDateTime at = OffsetDateTime.of(1900 + RandomUtils.nextInt(110),
                    1 + RandomUtils.nextInt(12), 1 + RandomUtils.nextInt(28),
                    RandomUtils.nextInt(24), RandomUtils.nextInt(60), RandomUtils.nextInt(60),
                    RandomUtils.nextInt(1000000000), ZoneOffset.UTC);
