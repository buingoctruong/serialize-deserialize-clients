...
<!-- TOC -->
* [Benchmark of Java JSON & XML libraries](#benchmark-of-java-json--xml-libraries)
  * [Purpose](#purpose)
  * [Java JSON Libraries](#java-json-libraries)
    * [Results](#results)
      * [Benchmark configuration](#benchmark-configuration)
    * [Run](#run)
  * [Java XML libraries](#java-xml-libraries)
    * [Results](#results-1)
      ...
      * [Users data](#users-data)
        ...
        * [Serialization](#serialization-1)
          ...
          * [10 KB](#10-kb-3)
          * [100 KB](#100-kb-3)
      * [Benchmark configuration](#benchmark-configuration-1)
    * [Run](#run-1)
<!-- TOC -->
...
![Deserialization performance clients data](json-clients/PerformanceCharts/DeserClientsData.png)

![Serialization performance clients data](json-clients/PerformanceCharts/SerClientsData.png)

![Deserialization performance users data](json-clients/PerformanceCharts/DeserUsersData.png)

![Serialization performance users data](json-clients/PerformanceCharts/SerUsersData.png)
